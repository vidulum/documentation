...
::: tip TIP:
Don't use the above height! Get a recent block height and header hash by visiting the explorer! Snapshots are taken at 375K block height intervals. 
:::
...
::: tip TIP:
Use the explorer and choose a block height & hash that is 375K blocks behind of the current block. Continue to increase by 100K until a snapshot is found.
:::
